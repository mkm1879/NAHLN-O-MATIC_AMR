...
public class SnomedMap {
	...
	public SnomedMap() {
		try {
			...
			while(sheetIterator.hasNext() ) {
				...
				if( "SNOMED".equals(s.getSheetName()) ) {
					...
					while(rowIterator.hasNext()) {
						...
						if( sCode == null ) {
							System.err.println("No SNOMED Code Found For: " + sLocal );
						}
						c = row.getCell(2);
			...
			System.err.println("Numeric cell read as string loading SnomedMap: " +  e.getMessage());
			e.printStackTrace();
		}catch( Exception e ) {
	...
	public CWE getCWE(Document doc, String sTag, String ssLocal) throws XMLException {
		...
		if( cv != null )
			...
			System.err.println("No SNOMED Code found for '" + ssLocal + "'");
		}
		return cwe;
	}
	...
	public CWE getCWE(Document doc, String sTag, String ssLocal, String sSerotype) throws XMLException {
		...
		if( cv != null )
			...
			System.err.println("No SNOMED Code found for '" + ssLocal  + "' '" + sSerotype + "'");
		}
		return cwe;
	}
}
